...
\begin{frame}[fragile]{Attack}{2 Types of 3-tuples}
	\begin{itemize}
...
\begin{frame}[fragile]{Attack}{Devide ID}
	...
	\begin{columns}
      ...
      \vspace{0.5cm}
      \includegraphics[width=\textwidth]{./figures/external/perturbation_table_collision.pdf}
		\end{column}
	...
	\end{columns}
	\begin{tikzpicture}[remember picture, overlay, shift={(current page.south west)}]
    \draw[thick, draw=PrimaryColor] (1cm,2.35cm) rectangle ++(0.36cm,0.36cm);
		\draw[thick, draw=PrimaryColor] (1.5cm,1.95cm) rectangle ++(0.36cm,0.36cm);
		% arrows
...
\begin{frame}[fragile]{Attack}{Sandwiching Technique}
  \begin{columns}
    ...
    \begin{column}[t]{0.6\textwidth}
      ...
      \includegraphics[width=0.6\textwidth]{./figures/external/cannot_see_collisions.pdf}
			\begin{itemize}
				\item \alert{side effect}: predictable increment
						\[
							\texttt{table[index]} \leftarrow \texttt{table[index]} + 1
						\]
          \item analalyse source port increments via \raisebox{-0.2\height}{\includegraphics[scale=0.015]{/home/areo/Documents/Studium/Semester_4_Master/Seminar/presentation/figures/sandwich_alpha.png}}
...
\begin{frame}[fragile]{Attack}{Sandwiching Technique}
	\begin{itemize}
		\item no direct access to kernel internals like \alert{perturbation table}%\raisebox{-0.2\height}{\includegraphics[width=0.04\textwidth]{./figures/perturbation_table.png}}
	...
	% 	\end{column}
	% 	\begin{column}{0.5\textwidth}
	%      \includegraphics[width=0.6\textwidth, center]{./figures/cern_tunnel.jpg}
	% 	\end{column}
	% \end{columns}
	\begin{itemize}
		\item \raisebox{-0.2\height}{\includegraphics[scale=0.02]{/home/areo/Documents/Studium/Semester_4_Master/Seminar/presentation/figures/analyse_patterns.png}} because of:
