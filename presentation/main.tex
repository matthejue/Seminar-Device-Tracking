...
\ifattackphaseone
	...
	%
	% 	\begin{adjustbox}{max width=\textwidth}
	% 		\tikzfig{phase1_overview} % ./figures/phase1_overview.tikz
	% 	\end{adjustbox}
	% 	% \grid
	% \end{frame}
...
\ifattackphasetwo
	...
	%
	% 	\begin{adjustbox}{max width=\textwidth}
	% 		\tikzfig{phase2_overview} % ./figures/phase2_overview.tikz
	% 	\end{adjustbox}
	% 	% \grid
	% \end{frame}
	...
	\begin{frame}[fragile]{Phase 2}{Termination condition}
		...
		\begin{itemize}
			...
			\begin{itemize}
				\item {\thickuparrow} $i$ \alert{$\Rightarrow$} $P^i_D(n)$ {\thickdownarrow}\, \alert{$\Rightarrow$} $P^i_D(n) < p^*$ closer to being satisfied % closer to termination
				\vspace{-0.4cm}

				\includegraphics[width=0.95\textwidth]{./figures/external/increase_i.pdf} % ./figures/external/increase_i.tikz
				\item {\thickuparrow} $n$ \alert{$\Rightarrow$} $P^i_D(n)$ {\thickdownarrow}\, \alert{$\Rightarrow$} $P^i_D(n) < p^*$ closer to being satisfied % closer to termination
				\vspace{-0.4cm}
