...
\definecolor{Increase}{HTML}{638d3a}
\definecolor{Decrease}{HTML}{de3209}
...
\setbeamercolor{author in head/foot}{fg=black, bg=PrimaryColorDimmed}
\setbeamercolor{title in head/foot}{fg=black, bg=SecondaryColorDimmed}
\setbeamercolor{date in head/foot}{fg=black, bg=PrimaryColorDimmed}

\setbeamercolor{section in head/foot}{fg=black,bg=PrimaryColorDimmed}

\setbeamercolor{palette primary}{fg=black,bg=PrimaryColorDimmed}
\setbeamercolor{palette secondary}{fg=black,bg=SecondaryColorDimmed}
\setbeamercolor{palette tertiary}{fg=black,bg=black}
\setbeamercolor{palette quaternary}{fg=black,bg=PrimaryColorDimmed}
...
% \setbeamercolor{section in head/foot}           {fg=black,bg=black}
% \setbeamercolor{section in head/foot shaded}    {fg=black,bg=black}
% \setbeamercolor{section in head/foot in head/foot}{fg=black,bg=black}
...
\leavevmode%
  \hbox{%
    ...
    \begin{beamercolorbox}[wd=\paperwidth,ht=2.5ex,dp=1.125ex]{palette quaternary}%
      \textcolor{black}{\insertsectionnavigationhorizontal{\paperwidth}{\hskip0pt plus1filll}{\hskip0pt plus1filll}}
    \end{beamercolorbox}%
  }
}
...
%   }
% }
\newcommand{\setsectionname}[1]{\def\currentsectionname{#1}}

% Default value
\setsectionname{}

% Custom centered headline
\setbeamertemplate{headline}{%
  \leavevmode%
  \hbox{%
    \begin{beamercolorbox}[wd=\paperwidth,ht=2.5ex,dp=1.125ex,center]{section in head/foot}
      \usebeamerfont{section in head/foot}\currentsectionname
    \end{beamercolorbox}%
  }%
}
...
\AtBeginSection[] {
  ...
  \begin{frame}
    \centering
    \textcolor{black}{\insertsectionHEAD}
  \end{frame}
  \endgroup
}
