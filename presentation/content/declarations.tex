...
\newcommand{\printtextwidth}{\printinunitsof{cm}\prntlen{\textwidth}}
\newcommand{\printlinewidth}{\printinunitsof{cm}\prntlen{\linewidth}}

\newcommand{\showtextwidth}{\rule{\textwidth}{1pt}}
\newcommand{\showlinewidth}{\rule{\linewidth}{1pt}}
...
\newcommand{\showcolumnwidth}{
	\begin{tikzpicture}
		\node[draw, inner sep=5pt, minimum width=\linewidth, anchor=north west] at (0,0) {
			\begin{minipage}[t]{\linewidth}
				This column has a border that matches its full width.

				You can add text, lists, etc.
			\end{minipage}
		};
	\end{tikzpicture}
}

\newcommand{\thickuparrow}{%
  \tikz[baseline=-0.5ex, line width=2pt, ->, >=angle 60] \draw[Increase] (0,-0.2) -- (0,0.3);%
}

\newcommand{\thickdownarrow}{%
  \tikz[baseline=-0.5ex, line width=2pt, ->, >=angle 60] \draw[Decrease] (0,0.3) -- (0,-0.2);%
}
