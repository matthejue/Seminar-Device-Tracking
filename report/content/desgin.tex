...
% │ Formatting │
% └────────────┘
\setlength{\parskip}{0.2cm} % space between paragraphs, https://latexref.xyz/bs-par.html
...
\titlecontents{subsubsection}[1.5cm]{\color{PrimaryColor}}{\thecontentslabel\quad}{\hspace{1cm}}{\titlerule*[0.5pc]{.}\contentspage}
