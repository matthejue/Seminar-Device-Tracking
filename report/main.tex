...
\begin{itemize}
	...
	\item The two \aalert{wrapper} steps each consist of a burst of TCP connection attempts to all unique attacker 3-tuples from phase 1 (Section~\ref{sec:phase 1}), and recording their assigned source ports $P(x)$.
\end{itemize}
