...
The explanation above illustrates the core idea of sandwiching in a simplified example. In practice, several additional factors must be taken into account:
